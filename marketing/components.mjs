...
export const APP = 'https://app.molar.it/signup';
...
export function header(active='') {
  ...
  }).join('')}<div class="mobile-auth"><a data-site-auth-link href="https://app.molar.it/login"><span data-site-auth-label>Sign in</span></a><a class="button button-primary" data-site-dashboard href="${APP}"><span data-site-dashboard-label>Get started</span> ${icon('arrow')}</a></div></nav><div class="header-actions"><a class="sign-in" data-site-auth-link href="https://app.molar.it/login"><span data-site-auth-label>Sign in</span></a><a class="button button-small button-primary" data-track="signup-nav" data-site-dashboard href="${APP}"><span data-site-dashboard-label>Get started</span> ${icon('arrow')}</a></div></div></header><div class="nav-scrim" aria-hidden="true"></div>`;
}
