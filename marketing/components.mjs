...
export function header(active='') {
  ...
  }).join('')}<div class="mobile-auth"><a href="https://app.molar.it/login">Sign in</a><a class="button button-primary" href="${APP}">Get started ${icon('arrow')}</a></div></nav><div class="header-actions"><a class="sign-in" href="https://app.molar.it/login">Sign in</a><a class="button button-small button-primary" data-track="signup-nav" href="${APP}">Get started ${icon('arrow')}</a></div></div></header><div class="nav-scrim" aria-hidden="true"></div>`;
}
