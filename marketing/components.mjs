...
export const faqsQA = [
  ...
  {q:'How do I get started?',a:'Create an account and add your app. Choose a flow to test, such as signing up or buying a plan. Molar is in beta; we can help connect the services your app uses.'}
];
