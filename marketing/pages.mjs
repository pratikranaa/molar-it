...
export const pages = [
  page({
    ...
    faqs: [
      ...
      { q: "What does a run return?", a: "A run can include status, task and trace identifiers, live view information when available, screenshots, and other captured evidence." },
  ...
  page({
    ...
    highlights: [
      { title: "Five core services", body: "Run Stripe, Twilio, Email, Auth, and S3 shaped clones alongside your app." },
      ...
      { title: "Callbacks you can inspect", body: "Exercise webhook delivery, retries, and vendor shaped signatures as part of the same test." },
    ],
    sections: [
  ...
  page({
    ...
    faqs: [
      { q: "Does Trace include video?", a: "Screenshots and trace evidence are available in supported runs. Video and HLS replay embedding are still in beta; contact us about your workflow." },
  ...
  page({
    ...
    sections: [
      { title: "Evidence led proposals", body: "Mender helps an engineer move from a reproducible failure toward a candidate patch, with the evidence and repository checks available for review.", bullets: ["Trace and Guard context", "Model inputs and outcomes", "Approval before repository changes"] },
      { title: "Preview access", body: "Mender is in preview. Talk to us about trying it with your team's repair workflow." },
    ],
    faqs: [
      { q: "How does Mender handle a failing test?", a: "Mender proposes and records a repair workflow; changes and publication remain approval gated." },
  ...
  page({
    ...
    sections: [
      { title: "One test environment for one journey", body: "Run your app against the Stripe, Twilio, Email, Auth, and S3 clones together. Snapshots and virtual time make the setup repeatable across local and CI workflows.", bullets: ["Five core service clones", "Vendor shaped APIs", "Deterministic snapshots and callbacks"] },
  ...
  page({
    ...
    highlights: [
      ...
      { title: "MCP native", body: "Connect an agent to `https://api.molar.it/mcp` or run the local stdio server through `molar mcp serve`." },
    ...
    sections: [
      { title: "Useful output for the next turn", body: "Task status, rationale, trace references, live view fields when available, and captured evidence give an agent enough context to diagnose and rerun.", bullets: ["JSON output", "Task polling", "Browser and identity tools"] },
  ...
  page({
    ...
    intro: "A small team often owns the product, the release, and the on call. Molar turns high consequence journeys into repeatable checks: signup with email, checkout with payment, and the webhook that changes state later.",
    ...
    highlights: [
      ...
      { title: "Grow into release checks", body: "The same scenario can become a CI check and, when available, a scheduled check for a live environment." },
    ],
    sections: [
      ...
      { title: "A focused start", body: "Molar is in private beta. Start with one high value journey, then expand coverage with our team." },
    ],
    faqs: [
  ...
  page({
    ...
    intro: "Molar can work with sensitive application behavior, so every run has a clear target, identity, and approval path. Workspace permissions, exact origin rules, access tokens, and confirmation steps keep browser, clone, trace, and MCP workflows accountable.",
    ...
    sections: [
      { title: "Credentials stay referenced", body: "Login tools use saved, exact origin credentials or opaque identity references. Connector controlled OTP and message reads stay with identities provisioned for your workspace.", bullets: ["No inline secrets for login tools", "Workspace profiles", "Audit and confirmation paths"] },
    ...
    faqs: [
      { q: "What security documentation is available?", a: "Contact us for current security documentation. Compliance status depends on the specific service and customer arrangement." },
...
const extraPages = [
  ...
  {path:"/solutions/team-workflows",title:"Team workflows | Molar",description:"Give engineers, QA, and coding agents one place to run journeys and inspect what happened.",headline:"Give every teammate the same answer.",intro:"A failed journey should be easy for the person who wrote it, reviewed it, or needs to fix it. Molar keeps the goal, browser evidence, service state, and next action together.",kind:"solution",visual:"collaboration",highlights:[{title:"Shared run context",body:"Keep the goal, environment, result, and evidence together."},{title:"Useful handoffs",body:"Share a trace with a teammate or coding agent instead of screenshots without context."},{title:"Repeatable checks",body:"Turn a useful investigation into a scenario your team can run again."}],sections:[{title:"A workflow for review",body:"An engineer runs a preview journey, a reviewer inspects the result, and an agent reads the status. Everyone works from one recorded run.",bullets:["Workspace permissions","Structured results","Trace links"],visual:"collaboration"},{title:"Keep the decision close",body:"Use Guard for release checks, Trace for investigation, and CLI or MCP when a coding tool needs to rerun verification.",bullets:["PR and CI workflows","Agent output","Completed, failed, and blocked states"],visual:"guard"}],faqs:[{q:"Is Molar only for QA specialists?",a:"Developers, QA, platform teams, and coding agents can use the same workflow."},{q:"Can we control who sees a run?",a:"Access follows your workspace permissions and authenticated project access."},{q:"Can a teammate rerun my flow?",a:"Supported workflows can be rerun with the target, credentials, and scenario settings your team provides."}],cta:"Bring your team into the loop"},
