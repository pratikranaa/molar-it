...
export const waitlistScript = `(function () {
  ...
  const copy = {
    ...
    cartographer: ['Cartographer early access', 'Browser exploration is in beta. Tell us which part of your application you want to explore first.'],
    guard: ['Guard early access', 'Release and production checks are in beta. Tell us which signup, checkout, or other test you want to run regularly.'],
    trace: ['Trace early access', 'Trace dashboards and MCP are in beta. Tell us which browser steps, screenshots, or failures your team needs to inspect.']
  }[ref.split(':')[0]];
  source.value = ref;
