...
export const waitlistScript = `(function () {
  ...
  const copy = {
    clones: ['Clones early access', 'Stateful service clones are rolling out in waves. Join the waitlist and we will reach out when you can spawn your first clone.'],
    cartographer: ['Cartographer early access', 'Agentic app mapping is rolling out in waves. Join the waitlist and we will reach out when you can map your app.'],
    guard: ['Guard early access', 'Production guard and PR gating are rolling out in waves. Join the waitlist and we will reach out when your workspace is ready.'],
    trace: ['Trace early access', 'Trace dashboards and MCP are rolling out in waves. Join the waitlist and we will reach out when your spot opens.']
  }[ref.split(':')[0]];
  source.value = ref;
