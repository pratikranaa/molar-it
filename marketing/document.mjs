...
const extraStyles=['illustrations.css','application-scene.css','service-lab.css','identity.css'].map(file=>`<link rel="stylesheet" href="/marketing/${file}?v=${revision('./'+file)}">`).join('');
