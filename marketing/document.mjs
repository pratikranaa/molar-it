...
const extraStyles=['illustrations.css','demo-surfaces.css'].map(file=>`<link rel="stylesheet" href="/marketing/${file}?v=${revision('./'+file)}">`).join('');
const imports=JSON.stringify({imports:{'molar-demo':`/marketing/demo-surfaces.mjs?v=${revision('./demo-surfaces.mjs')}`}});
