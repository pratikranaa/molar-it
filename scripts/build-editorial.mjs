...
const card=x=>'<a class="blog-entry" data-blog-entry data-category="'+esc(x.category)+'" href="'+x.path+'"><div class="article-cover cover-'+x.category.toLowerCase()+'"><span class="cover-line"></span><span class="cover-icon">'+icon(x.category==='Integrations'?'layers':x.category==='Agents'?'code':'trace')+'</span><span class="cover-line"></span></div><div class="entry-meta"><span>'+esc(x.category)+'</span><time datetime="'+x.date+'">'+x.date+'</time></div><h2>'+esc(x.title)+'</h2><p>'+inline(description(x))+'</p><span class="read-link">Read guide '+icon('arrow')+'</span></a>';
